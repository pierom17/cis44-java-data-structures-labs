public class SearchComparison {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nComparison Test for Finding 30:");
        System.out.println("Linear Search Result: Index " + linearSearch(sortedData, 30));
        System.out.println("Binary Search Result: Index " + binarySearch(sortedData, 30));
    }
}